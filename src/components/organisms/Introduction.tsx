        ...
        <div className="flex flex-col items-center">
          ...
          <div className="p-5 justify-center"> 
            ...
            <div className="p-5 md:p-3 text-center">
              <p className="text-light text-md md:text-2xl">I enjoy editing various types of videos, I especially like to working on shorts, longform, and motion graphics.</p>
