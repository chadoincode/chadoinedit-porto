  ...
  return(
    <div className="border-2 flex flex-col items-center p-3 mt-10 pt-5 ">
      ...
      <div className="p-5 border-2 justify-center"> 
        <h1 className="text-light text-4xl text-center">Known as cha — A Video Editor & Motion Graphics Enthusiast</h1>
        ...
        <div className="flex gap-2 justify-center">
          <Button link='https://www.instagram.com/sgxwraa' text="Instagram" />
