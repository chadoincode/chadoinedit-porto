  ...
  return(
    <div className="flex flex-col items-center p-3 mt-10 pt-5 ">
      ...
      <div className="p-5 justify-center"> 
        <h1 className="text-light text-2xl text-center font-medium">Known as <u>cha</u> — A Video Editor & Motion Graphics Enthusiast</h1>
        <div className="p-3 text-center">
          <p className="text-light text-lg">I enjoy editing various types of videos, I especially like to working on longform, shorts, and motion graphics.</p>
          <p className="text-light text-lg">If you'd like to work with me, feel free to reach out!</p>
        </div>
        <div className="text-center">
          <p className="text-light text-lg underline">My Socials:</p>
